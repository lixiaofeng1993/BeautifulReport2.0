...
HTML_IMG_TEMPLATE = """
    ...
    <img src="data:image/png;base64, {}" width="500px" height="800px"/>
    </a>
    <br></br>
"""
...
class BeautifulReport(ReportTestResult, PATH):
    img_path = 'UIAutomation/report/img/' if platform.system() != 'Windows' else 'UIAutomation\\report\\img\\'  # img文件放到UIAutomation\\report目录下,从项目根目录写起
    ...
    def add_test_img(*pargs):
        ...
        def _wrap(func):
            ...
            def __wrap(*args, **kwargs):
                ...
                _path = os.path.abspath('.').split('UIAutomation')[0]
                img_path = os.path.join(_path, BeautifulReport.img_path)
                try:
